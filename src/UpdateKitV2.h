...
typedef enum
{
	...
	US_TV_IN_STANDBY,
	US_PWM_WELCOME,			// For voltage output branch
	US_PWM_CHECK_SEL,		// For voltage output branch
	US_PWM_OUT_ON,			// For voltage output branch
	US_PWM_OUT_OFF,			// For voltage output branch
	US_PWM_USER_CTRL,		// For voltage output branch
	US_MAX_STATE_NO						// 11
} UPDATE_STATE;
...
//	LCM_DEV_OK_DETECT_PAGE,
	LCM_PWM_WELCOME,	// For voltage output branch
	LCM_PWM_OUT_ON,		// For voltage output branch
	LCM_PWM_OUT_OFF,	// For voltage output branch
	LCM_PWM_USER_CTRL,	// For voltage output branch
	LCM_MAX_PAGE_NO
} LCM_PAGE_ID;
