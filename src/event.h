...
#define EVENTS_IN_USE_AND_FLAG()	(EVENT_filtered_current_above_threshold && EVENT_filtered_current_unplugged_debounced && EVENT_filtered_current_TV_standby_debounced && 				\
							 	 	 EVENT_OK_string_confirmed && EVENT_Version_string_confirmed && EVENT_Button_pressed_debounced)

#define EVENTS_IN_USE_OR_FLAG()		(EVENT_filtered_current_above_threshold || EVENT_filtered_current_unplugged_debounced || EVENT_filtered_current_TV_standby_debounced ||				\
							 	 	 EVENT_OK_string_confirmed || EVENT_Version_string_confirmed || EVENT_Button_pressed_debounced)
