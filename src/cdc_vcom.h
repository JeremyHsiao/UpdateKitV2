...
extern int CDC_OutputHexValue(uint32_t value);
extern int CDC_OutputHexValue_with_newline(uint32_t value);
extern int CDC_OutputString(char *str);
extern int CDC_OutputString_with_newline(char *str);
extern int CDC_OutputData(uint8_t *str, int len);

#define CDC_NEW_LINE_SYMBOL		_R_N_
//#define CDC_NEW_LINE_SYMBOL		_N_
